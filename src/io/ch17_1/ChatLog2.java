...
public class ChatLog2 {
    ...
    private static void searchByName(String keyword) {
    ...
    private static void saveChat() {
        ...
        //FileWriter("파일 명") -> BufferedWriter()
